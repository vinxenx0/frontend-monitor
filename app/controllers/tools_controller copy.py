...
def analisis_aaa():
  ...
  # Convertir objetos Sumario a diccionarios
   ...
   # Consulta para obtener las filas correspondientes de la tabla Sumario
    ...
    # Enviamos los resultados al template
    return render_template('tools/usa/analisis_aaa.html', dominios_ordenados=DOMINIOS_ESPECIFICOS, graficos=json.dumps(sumarios_dict), evolucion = json.dumps(evoluciones_dict), resultados=paginas_wcagaaa, detalles=resultados_agrupados, resumen=sumarios)
...
def ortografia():
 ...
 # Consulta para obtener las filas correspondientes de la tabla Sumario
    ...
    # Enviamos los resultados al template
    return render_template('tools/dicc/ortografia.html', dominios_ordenados=DOMINIOS_ESPECIFICOS, graficos=json.dumps(sumarios_dict), evolucion = json.dumps(evoluciones_dict), resultados=paginas_ortografia, detalles_dos = resultados_agrupados_dos, detalles=resultados_agrupados, resumen=sumarios)
...
def contar_enlaces(response_text, url):
    ...
    return {
        ...
        "enlaces_rotos": len(enlaces_rotos),
